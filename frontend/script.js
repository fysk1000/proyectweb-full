...
const App = (function() {
  ...
  const INLINE_FALLBACK_IMAGE = 'data:image/svg+xml;base64,';
  ...
  function bindImageFallback(imgEl, fallbackSrc) {
    imgEl.addEventListener('error', function onImgError() {
      ...
      const hasTriedPrimaryFallback = imgEl.dataset.fallbackTried === '1';
      const hasTriedInlineFallback = imgEl.dataset.inlineFallbackTried === '1';

      if (!hasTriedPrimaryFallback && fallbackSrc && currentSrc !== fallbackSrc) {
        imgEl.dataset.fallbackTried = '1';
        imgEl.src = fallbackSrc;
        return;
      }

      if (!hasTriedInlineFallback && currentSrc !== INLINE_FALLBACK_IMAGE) {
        imgEl.dataset.inlineFallbackTried = '1';
        imgEl.src = INLINE_FALLBACK_IMAGE;
        return;
      }
